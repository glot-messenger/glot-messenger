...
export const LEFT_EVENT_SEGMENT = '.the-left';
export const RIGHT_EVENT_SEGMENT = '.the-right';
export const BEGINNING_EVENT_SEGMENT = '.beginning';
export const ENDING_EVENT_SEGMENT = '.ending';
...
export const MOVING_LEFT_COLUMN_EVENT_SEGMENT = COLUMN_EVENT_SEGMENT + MOVING_EVENT_SEGMENT + LEFT_EVENT_SEGMENT;
export const MOVING_RIGHT_COLUMN_EVENT_SEGMENT = COLUMN_EVENT_SEGMENT + MOVING_EVENT_SEGMENT + RIGHT_EVENT_SEGMENT;
export const MOVING_BEGINNING_COLUMN_EVENT_SEGMENT = COLUMN_EVENT_SEGMENT + MOVING_EVENT_SEGMENT + BEGINNING_EVENT_SEGMENT;
export const MOVING_ENDING_COLUMN_EVENT_SEGMENT = COLUMN_EVENT_SEGMENT + MOVING_EVENT_SEGMENT + ENDING_EVENT_SEGMENT;
// SOCIAL NETWORK
