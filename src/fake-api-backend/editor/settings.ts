...
// СТОРОННИЙ МЕТОД ОБНОВЛЕНИЯ СТОРА ДЛЯ БОРЬБЫ С МУТАЦИЕЙ
export function overwritingSettings(newSettings: any) {
	settingsAll = newSettings;
};
